...
load("data/coll_model_data_summer")
...
tiff('figs/occ_summer.tif', pointsize = 8, compression = "lzw", res=300, width = 1100, height = 900)
ggplot(occ.summer,aes(x=x,y=y,group=col,colour=factor(col))) +
  geom_line(size=0.3) +
  ylab("Likelihood of Collision") +
  xlab("Likelihood of Species Occurrence") +
  labs(color = "Species") +
